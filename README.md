...
* Notes on Individual Sensors
  * Motion
    ...
    * Wyze motion sensors will keep reporting the `on` state for 40 seconds after the last motion is detected. This is non configurable but in practice this isn't a big deal and is usually the behaviour you want. Just something to be aware of.
  * Door
